...
logger = logging.getLogger("train_vgg16")
...
if __name__ == '__main__':
    ...
    model = Vgg16(X, keep_prob, hparams.num_classes,train_layers)
    ...
    with tf.Session() as sess:
        ...
        summary_writer = tf.summary.FileWriter("train_vgg16", sess.graph)
        step = 0
        epoch = 0
        while True:
            #train
            ...
            try:
                ...
                sess.run(tr_iterator.initializer)
                saver.save(sess,"./ckpt/vgg16.ckpt",global_step = step)
                #val
                val_acc = 0
                val_count = 0
                while True:
